...
description: "Como construir, aplicar e interpretar essas ferramentas estatísticas"
author:
...
```{r echo=FALSE, fig.cap="**Figura 1:** Para uma confiança de (100 - $\\alpha$)%, a área em cada cauda da distribuição deverá ser de $\\alpha$/2 para que o intervalo seja o menor possível.", out.width = '80%'}
knitr::include_graphics("normal_padrao.png")
```
...
```{r echo=FALSE, fig.cap="**Figura 2:** Para uma confiança de (100 - $\\alpha$)%, a área em cada cauda da distribuição deverá ser de $\\alpha$/2 para que o intervalo seja o menor possível.", out.width = '80%'}
knitr::include_graphics("t_student.png")
```
